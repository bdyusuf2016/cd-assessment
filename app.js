...
<body style="font-family: 'Noto Serif Bengali', 'SolaimanLipi', 'Kalpurush', 'Hind Siliguri', 'Inter', sans-serif !important; color: #000000 !important; background: #ffffff !important; background-color: #ffffff !important; background-image: none !important; padding: 0 !important; margin: 0 !important; width: 1122px !important; min-height: 794px !important; overflow: visible !important; font-size: 9.5pt !important; line-height: 1.4 !important;">
  <div class="sheet" style="width: 1122px !important; max-width: 1122px !important; min-height: 794px !important; background: #ffffff !important; background-color: #ffffff !important; background-image: none !important; color: #000000 !important;">
    ...
    <table class="assessment-table" style="width: 100% !important; border-collapse: collapse !important; table-layout: auto !important; margin-bottom: 14px !important; font-size: 9pt !important; background: #fff !important; background-color: #fff !important; border: 1px solid #000 !important;">
      <thead>
        <tr>
          ...
          <th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">${dict.totalPrice}</th>
          <th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">${dict.insurance}</th>
          <th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">${dict.landing}</th>
          <th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">${dict.assessableVal}</th>
          ${cv.cd ? `<th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">CD (${lang === "bn" ? toBengaliNumerals(dr.cd) : dr.cd}%)</th>` : ''}
          ${cv.rd ? `<th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">RD (${lang === "bn" ? toBengaliNumerals(dr.rd) : dr.rd}%)</th>` : ''}
          ${cv.sd ? `<th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">SD (${lang === "bn" ? toBengaliNumerals(dr.sd) : dr.sd}%)</th>` : ''}
          ${cv.vat ? `<th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">${dict.vat} (${lang === "bn" ? toBengaliNumerals(dr.vat) : dr.vat}%)</th>` : ''}
          ${cv.ait ? `<th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">AIT (${lang === "bn" ? toBengaliNumerals(dr.ait) : dr.ait}%)</th>` : ''}
          ${cv.at ? `<th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">AT (${lang === "bn" ? toBengaliNumerals(dr.at) : dr.at}%)</th>` : ''}
          <th style="border: 1px solid #000 !important; padding: 6px 2px !important; font-weight: 700 !important; text-align: center !important; font-size: 7.2pt !important; height: 42px !important; line-height: 1.25 !important; background: #fff !important; color: #000 !important;">${dict.dutyTax}</th>
        </tr>
      </thead>
      <tbody>
    ...
    <div class="code-instruction-box" style="margin-top: 16px !important; border: 1px solid #000000 !important; padding: 6px 12px !important; font-size: 8.5pt !important; background: #ffffff !important; color: #000000 !important; width: 100% !important;">
      <div style="display: flex !important; justify-content: space-between !important; align-items: center !important; margin-bottom: 4px !important; background: #ffffff !important; color: #000000 !important;">
        ...
        <div style="font-weight: 700 !important; font-size: 8pt !important; color: #000000 !important; background: #ffffff !important;">
          Customs Bond Commissionerate, Dhaka(South) এর অফিস কোড : <strong>1110208102384</strong>
        </div>
      </div>
      <div style="display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 10px !important; font-size: 8pt !important; line-height: 1.35 !important; background: #ffffff !important; color: #000000 !important;">
        <div style="background: #ffffff !important; color: #000000 !important;"><strong>1151101 :</strong> ${lang === "bn" ? "কাস্টমস শুল্ক (CD + RD)" : "Customs Duty (CD + RD)"} = <strong>${formatCurrency((cv.cd ? totCd : 0) + (cv.rd ? totRd : 0), lang)}</strong></div>
        <div style="background: #ffffff !important; color: #000000 !important;"><strong>1141104 :</strong> ${lang === "bn" ? "আমদানি পণ্যের উপর মূসক (VAT + ATD)" : "Import VAT (VAT + ATD)"} = <strong>${formatCurrency((cv.vat ? totVat : 0) + (cv.sd ? totSd : 0) + (cv.at ? totAt : 0), lang)}</strong></div>
        <div style="background: #ffffff !important; color: #000000 !important;"><strong>1112101 :</strong> ${lang === "bn" ? "কোম্পানিসমূহ কর্তৃক দেয় আয়কর (AIT)" : "Income Tax on Companies (AIT)"} = <strong>${formatCurrency(cv.ait ? totAit : 0, lang)}</strong></div>
      </div>
    </div>
